...
export declare class Repository<Entity extends ObjectLiteral> {
     ...
     */
    update(criteria: string | string[] | number | number[] | Date | Date[] | ObjectId | ObjectId[] | FindOptionsWhere<Entity> | FindOptionsWhere<Entity>[], partialEntity: QueryDeepPartialEntity<Entity>): Promise<UpdateResult>;
    /**
     ...
     */
    updateAll(partialEntity: QueryDeepPartialEntity<Entity>): Promise<UpdateResult>;
    /**
