...
`;
    ...
    _computeFullGraphicUrl(url) {
        ...
        a.href = url;
        let absUrl = a.href;
        if (((_a = window.ncgConfig.login) === null || _a === void 0 ? void 0 : _a.enabled) && window.token) {
    ...
    _calcCount(singleInstance, instances) {
        ...
        return (_a = instances === null || instances === void 0 ? void 0 : instances.filter((instance) => instance.open).length) !== null && _a !== void 0 ? _a : "?";
    }
...
//# sourceMappingURL=ncg-graphic.js.map