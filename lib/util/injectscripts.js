...
module.exports = function (pathOrHtml, resourceType, opts, cb) {
	...
	function inject(err, html) {
		...
		if (resourceType === 'panel' || resourceType === 'dialog') {
			...
			scripts.push('<link rel="stylesheet" href="/dashboard/style/panel-and-dialog-defaults.css">');
			...
			if (resourceType === 'panel') {
				styles.push('<link rel="stylesheet" href="/dashboard/style/panel-defaults.css">');
