	...
	Polymer({
		...
		properties: {
			...
			workspaces: {
				type: Array,
				value() {
					const workspaces = window.__renderData__.workspaces;

					// Give the default workspace a more meaningful display name
					workspaces[0].name = workspaces.length === 1 ? 'Workspace' : 'Main Workspace';
