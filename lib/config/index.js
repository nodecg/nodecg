...
ConfigHelper.prototype.init = function(baseDirectory) {
    if (baseDir !== null) {
...
ConfigHelper.prototype.getConfig = function() {
    return extend(true, {}, config);
};

ConfigHelper.prototype.getFilteredConfig = function() {
...
function _createFilteredConfig() {
    filteredConfig = {
        ...
        login: {
            enabled: defaultConfig.login.enabled,
            steam: {
                enabled: defaultConfig.login.steam.enabled
            },
            twitch: {
                enabled: defaultConfig.login.twitch.enabled
            }
        }
    };
}
