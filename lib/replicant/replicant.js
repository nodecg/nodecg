	...
	constructor(name, namespace, opts = {}) {
		...
		if (opts.persistent && typeof existingValue !== 'undefined' && existingValue !== null) {
			...
			if (defaultValue && typeof defaultValue === 'object') {
				this.log.replicants('Default value is an object. Please use a factory function instead for avoiding mutation issues.');
			}
			...
			this.value = shared._proxyRecursive(this, defaultValue, '/');
