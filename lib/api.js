 ...
 * Can be a factory function for avoiding reference issues, like objects.
 ...
 *
 * @example <caption>Using `defaultValue` as factory function</caption>
 * const myObjectRep = nodecg.Replicant('myRep', {
