...
if (process.env.browser) {
	...
	let printedNearestElementDepNotice = false;
	/**
	 * _Browser only_<br/>
	...
	NodeCG.nearestElementWithAttribute = function (startEl, attrName) {
		if (!printedNearestElementDepNotice) {
			console.warn('NodeCG.nearestElementWithAttribute is deprecated, ' +
				'and will be removed in 0.8.0. Use element.closest() instead: ' +
				'https://developer.mozilla.org/en-US/docs/Web/API/Element/closest');
			printedNearestElementDepNotice = true;
		}
