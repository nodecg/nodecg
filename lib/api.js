 ...
 * Messages can be sent from client to server, or server to client.
 *
 ...
 * When a Replicant changes in one of those places it is immediately updated in the rest,
 ...
 * nodecg.readSyncedVar('myVal', 'some-bundle', function(value) {
 *     // I can use 'value' now!
