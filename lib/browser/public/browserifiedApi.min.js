...
"use strict";function NodeCG(e,n){var t=this;if(this.bundleName=e.name,this.bundleConfig=e.config,this.log=require("./browser/logger")(e.name),this._messageHandlers=[],"undefined"==typeof io)throw new Error("[nodeceg] Socket.IO must be loaded before instantiating the API");document.addEventListener("DOMContentLoaded",function(){""===document.title&&(document.title=t.bundleName)},!1),this.socket=n,this.socket.emit("joinRoom",e.name),n.on("message",function(e){t.log.trace("[%s] Received message %s (sent to bundle %s) with data:",t.bundleName,e.messageName,e.bundleName,e.content),t._messageHandlers.forEach(function(n){e.messageName===n.messageName&&e.bundleName===n.bundleName&&n.func(e.content)})}),n.on("error",function(e){if("UnauthorizedError"===e.type){var n=[location.protocol,"//",location.host,location.pathname].join("");window.location.href="/authError?code="+e.code+"&message="+e.message+"&viewUrl="+n}else t.log.error("Unhandled socket error:",e)}),Object.defineProperty(this,"config",{value:filteredConfig,writable:!1,enumerable:!0}),Object.freeze(this.config)}var Replicant=require("./browser/replicant"),io={},server=require("./server"),filteredConfig=require("./config").getFilteredConfig(),utils=require("./util"),replicator=require("./replicator");NodeCG.prototype.sendMessage=function(e,n,t){"undefined"==typeof t&&"function"==typeof n&&(t=n,n=null),this.sendMessageToBundle(e,this.bundleName,n,t)},NodeCG.sendMessageToBundle=function(e,n,t,o){"undefined"==typeof o&&"function"==typeof t&&(o=t,t=null),window.socket.emit("message",{bundleName:n,messageName:e,content:t},o)},NodeCG.prototype.sendMessageToBundle=function(e,n,t,o){this.log.trace("[%s] Sending message %s to bundle %s with data:",this.bundleName,e,n,t),NodeCG.sendMessageToBundle.apply(NodeCG,arguments)},NodeCG.prototype.listenFor=function(e,n,t){"undefined"==typeof t&&(t=n,n=this.bundleName),this.log.trace("[%s] Listening for %s from bundle %s",this.bundleName,e,n);for(var o=this._messageHandlers.length,i=0;o>i;i++){var s=this._messageHandlers[i];if(e===s.messageName&&n===s.bundleName)return void this.log.error('%s attempted to declare a duplicate "listenFor" handler:',this.bundleName,n,e)}this._messageHandlers.push({messageName:e,bundleName:n,func:t})},NodeCG.Replicant=function(e,n,t){return new Replicant(e,n,t,window.socket)},NodeCG.prototype.Replicant=function(e,n,t){return n&&"string"==typeof n||(t=n,n=this.bundleName),NodeCG.Replicant(e,n,t)},NodeCG.readReplicant=function(e,n,t){if(!e||"string"!=typeof e)throw new Error("Must supply a name when reading a Replicant");if(!n||"string"!=typeof n)throw new Error("Must supply a bundle name when reading a Replicant");window.socket.emit("readReplicant",{name:e,bundle:n},t)},NodeCG.prototype.readReplicant=function(e,n,t){return n&&"string"==typeof n||(t=n,n=this.bundleName),NodeCG.readReplicant(e,n,t)},window.NodeCG=NodeCG,module.exports=NodeCG;
