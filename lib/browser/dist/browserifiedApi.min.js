...
(function (process){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),EventEmitter=require("events"),equal=require("deep-equal"),clone=require("clone"),uuid=require("uuid"),shared=require("../replicant/shared"),declaredReplicants={},REPLICANT_HANDLER={get:function(e,t){return e[t]},set:function(e,t,n){if("value"!==t)throw new Error('All Replicant properties (with the exception of "value") are read-only');return n===e[t]?(e.log.replicants("value unchanged, no action will be taken"),e.value):(e.log.replicants("running setter with",n),"declared"!==e.status?void e._queueAction(e._doBrowserSetter,[n]):void e._doBrowserSetter(n))}},Replicant=function(e){function t(e,n,i,r){var s;if(_classCallCheck(this,t),!e||"string"!=typeof e)throw new Error("Must supply a name when instantiating a Replicant");if(!n||"string"!=typeof n)throw new Error("Must supply a bundle name when instantiating a Replicant");if(declaredReplicants.hasOwnProperty(n)){if(declaredReplicants[n].hasOwnProperty(e)){var a;return a=declaredReplicants[n][e],_possibleConstructorReturn(o,a)}}else declaredReplicants[n]={};var o=_possibleConstructorReturn(this,Object.getPrototypeOf(t).call(this));return declaredReplicants[n][e]=o,o.log=require("./logger")("Replicant/"+n+"."+e),i=i||{},o.value=void 0,o.name=e,o.bundle=n,o.opts=i,o.revision=0,o.status="undeclared",o.id=uuid.v4(),o._socket=r,"undefined"==typeof i.persistent&&(i.persistent=!0),o.on("newListener",function(e,t){"change"===e&&"declared"===o.status&&t(o.value)}),o._actionQueue=[],o._doBrowserDeclare(),r.on("replicant:assignment",function(e){return o._handleAssignment(e)}),r.on("replicant:operations",function(e){return o._handleOperations(e)}),r.on("disconnect",function(){return o._handleDisconnect}),r.on("reconnect",function(){return o._doBrowserDeclare()}),s=new Proxy(o,REPLICANT_HANDLER),_possibleConstructorReturn(o,s)}return _inherits(t,e),_createClass(t,[{key:"_addOperation",value:function(e,t,n){var i=this;this._operationQueue.push({path:e,method:t,args:n}),this._pendingOperationFlush||(this._pendingOperationFlush=!0,"declared"===this.status?process.nextTick(function(){return i._flushOperations()}):this._queueAction(this._flushOperations))}},{key:"_flushOperations",value:function(){var e=this;this._pendingOperationFlush=!1,this._socket.emit("replicant:proposeOperations",{name:this.name,bundle:this.bundle,operations:this._operationQueue,revision:this.revision,originatorId:this.id},function(t,n){e.log.warn("Not at head revision (ours %s, theirs %s). Change aborted & head revision applied.",e.revision,n),e._assignValue(t,n)}),this._operationQueue=[]}},{key:"_queueAction",value:function(e,t){this._actionQueue.push({fn:e,args:t})}},{key:"_processActions",value:function(){var e=this;this._actionQueue.forEach(function(t){return t.fn.apply(e,t.args)}),this._actionQueue=[]}},{key:"_doBrowserSetter",value:function(e){this._socket.emit("replicant:proposeAssignment",{name:this.name,bundle:this.bundle,value:e,originatorId:this.id})}},{key:"_doBrowserDeclare",value:function(){var e=this;"declared"!==this.status&&"declaring"!==this.status&&(this.status="declaring",this._socket.emit("joinRoom",this.bundle,function(){e._socket.emit("replicant:declare",{name:e.name,bundle:e.bundle,defaultValue:e.opts.defaultValue,persistent:e.opts.persistent},function(t){e.log.replicants("declareReplicant callback (value: %s, revision: %s)",t.value,t.revision);var n=!1;e.revision===t.revision&&equal(e.value,t.value)||(e._assignValue(t.value,t.revision),n=!0),e.status="declared",e.emit("declared",t),e._actionQueue.length>0?e._processActions():n||e.emit("change",t.value),e._actionQueue.length=0})}))}},{key:"_assignValue",value:function(e,t){var n=clone(this.value);this.value=shared._proxyRecursive(e,"/"),"undefined"!=typeof t&&(this.revision=t),this.emit("change",this.value,n)}},{key:"_handleAssignment",value:function(e){e.name===this.name&&e.bundle===this.bundle&&(this.log.replicants("replicantAssigned",e),e.originatorId===this.id&&this.emit("assignmentAccepted",e),this._assignValue(e.newValue,e.revision))}},{key:"_handleOperations",value:function(e){var t=this;if("declared"===this.status&&e.name===this.name&&e.bundle===this.bundle){if(e.revision!==this.revision+1)return this.log.warn("Not at head revision (ours %s, theirs %s), fetching latest...",this.revision,e.revision),void this._fullUpdate();this.log.replicants("replicantOperations",e);var n=clone(this.value);e.operations.forEach(function(e){return shared.applyOperation(t,e)}),this.revision=e.revision,this.emit("change",this.value,n,e.operations)}}},{key:"_handleDisconnect",value:function(){this.status="undeclared",this._operationQueue.length=0,this._actionQueue.length=0}},{key:"_fullUpdate",value:function(){var e=this;NodeCG.readReplicant(this.name,this.bundle,function(t){e.emit("fullUpdate",t),e._assignValue(t.value,t.revision)})}}]),t}(EventEmitter);module.exports=Replicant;
}).call(this,require('_process'))

},{"../replicant/shared":5,"./logger":3,"_process":18,"clone":11,"deep-equal":12,"events":15,"uuid":20}],5:[function(require,module,exports){
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,_=Array(e.length);t<e.length;t++)_[t]=e[t];return _}return Array.from(e)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},objectPath=require("object-path"),ARRAY_MUTATOR_METHODS=["copyWithin","fill","pop","push","reverse","shift","sort","splice","unshift"],CHILD_ARRAY_HANDLER={get:function(e,t){return ARRAY_MUTATOR_METHODS.indexOf(t)>=0?function(){e.__ncg_replicant__._addOperation(e.__ncg_target_path__,t,arguments)}:e[t]},set:function(e,t,_){e.hasOwnProperty(t)?e.__ncg_replicant__._addOperation(e.__ncg_target_path__,"update",_):e.__ncg_replicant__._addOperation(e.__ncg_target_path__,"add",_)}},CHILD_OBJECT_HANDLER={get:function(e,t){return e[t]},set:function(e,t,_){e.hasOwnProperty(t)?e.__ncg_replicant__._addOperation(e.__ncg_target_path__,"update",_):e.__ncg_replicant__._addOperation(e.__ncg_target_path__,"add",_)}};module.exports={ARRAY_MUTATOR_METHODS:ARRAY_MUTATOR_METHODS,_proxyRecursive:function(e,t){if("object"===("undefined"==typeof e?"undefined":_typeof(e))){Object.defineProperties({__ncg_replicant__:{enumerable:!1,writable:!1,value:this},__ncg_target_path__:{enumerable:!1,writable:!1,value:t}});var _=Array.isArray(e)?CHILD_ARRAY_HANDLER:CHILD_OBJECT_HANDLER,r=new Proxy(e,_);for(var a in e)e.hasOwnProperty(a)&&(e[a]=this._proxyRecursive(e[a],t+"/"+a.replace(/\//g,"~1")));return r}return e},applyOperation:function(e,t){if(ARRAY_MUTATOR_METHODS.indexOf(t.method)>=0){var _=objectPath.get(e.value,t.path);_[t.method].apply(_,_toConsumableArray(t.args))}else switch(t.method){case"add":case"update":var r=t.newValue;"object"===_typeof(t.newValue)&&(r=this._proxyRecursive(r,t.path)),objectPath.set(e.value,t.path,r);break;case"delete":objectPath.del(e.value,t.path)}}};
