...
"use strict";function NodeCG(e,t){var n=this;this.bundleName=e.name,this.bundleConfig=e.config,this.log=require("./browser/logger")(e.name),this._messageHandlers=[],document.addEventListener("DOMContentLoaded",function(){""===document.title&&(document.title=n.bundleName)},!1),this.socket=t,this.socket.emit("joinRoom",e.name),t.on("message",function(e){n.log.trace("Received message %s (sent to bundle %s) with data:",e.messageName,e.bundleName,e.content),n._messageHandlers.forEach(function(t){e.messageName===t.messageName&&e.bundleName===t.bundleName&&t.func(e.content)})}),t.on("error",function(e){if("UnauthorizedError"===e.type){var t=[location.protocol,"//",location.host,location.pathname].join("");window.location.href="/authError?code="+e.code+"&message="+e.message+"&viewUrl="+t}else n.log.error("Unhandled socket error:",e)}),Object.defineProperty(this,"config",{value:filteredConfig,writable:!1,enumerable:!0}),Object.freeze(this.config)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},Replicant=require("./browser/replicant"),server=require("./server"),filteredConfig=require("./browser/config").filteredConfig,utils=require("./util"),replicator=require("./replicator"),io=void 0;NodeCG.prototype.sendMessage=function(e,t,n){"undefined"==typeof n&&"function"==typeof t&&(n=t,t=null),this.sendMessageToBundle(e,this.bundleName,t,n)},NodeCG.sendMessageToBundle=function(e,t,n,o){"undefined"==typeof o&&"function"==typeof n&&(o=n,n=null),window.socket.emit("message",{bundleName:t,messageName:e,content:n},o)},NodeCG.prototype.sendMessageToBundle=function(e,t,n,o){this.log.trace("[%s] Sending message %s to bundle %s with data:",this.bundleName,e,t,n),NodeCG.sendMessageToBundle.apply(NodeCG,arguments)},NodeCG.prototype.listenFor=function(e,t,n){if("undefined"==typeof n&&(n=t,t=this.bundleName),"function"!=typeof n)throw new Error('argument "handler" must be a function, but you provided a(n) '+("undefined"==typeof n?"undefined":_typeof(n)));this.log.trace("[%s] Listening for %s from bundle %s",this.bundleName,e,t);for(var o=this._messageHandlers.length,i=0;o>i;i++){var r=this._messageHandlers[i];if(e===r.messageName&&t===r.bundleName)return void this.log.error('%s attempted to declare a duplicate "listenFor" handler:',this.bundleName,t,e)}this._messageHandlers.push({messageName:e,bundleName:t,func:n})},NodeCG.declaredReplicants=Replicant.declaredReplicants,NodeCG.Replicant=function(e,t,n){return new Replicant(e,t,n,window.socket)},NodeCG.prototype.Replicant=function(e,t,n){return t&&"string"==typeof t||(n=t,t=this.bundleName),new NodeCG.Replicant(e,t,n)},NodeCG.readReplicant=function(e,t,n){if(!e||"string"!=typeof e)throw new Error("Must supply a name when reading a Replicant");if(!t||"string"!=typeof t)throw new Error("Must supply a bundle name when reading a Replicant");window.socket.emit("readReplicant",{name:e,bundle:t},n)},NodeCG.prototype.readReplicant=function(e,t,n){return t&&"string"==typeof t||(n=t,t=this.bundleName),NodeCG.readReplicant(e,t,n)},!function(){window.NodeCG=NodeCG;var e=!1;NodeCG.nearestElementWithAttribute=function(t,n){e||(console.warn("NodeCG.nearestElementWithAttribute is deprecated, and will be removed in 0.8.0. Use element.closest() instead: https://developer.mozilla.org/en-US/docs/Web/API/Element/closest"),e=!0);for(var o=t;o;){if(o.hasAttribute&&o.hasAttribute(n))return o;o=o.parentNode}},NodeCG.prototype.getDialog=function(e,t){return t=t||this.bundleName,window.top.document.getElementById(t+"_"+e)},NodeCG.prototype.getDialogDocument=function(e,t){return t=t||this.bundleName,this.getDialog(e,t).querySelector("iframe").contentWindow.document}}(),module.exports=NodeCG;
