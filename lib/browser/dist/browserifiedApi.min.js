...
(function (process){
"use strict";function proxyRecursive(e,r,t){if("object"===("undefined"==typeof r?"undefined":_typeof(r))&&null!==r){var o=void 0;if(proxyMap.has(r))o=proxyMap.get(r);else{var a=Array.isArray(r)?CHILD_ARRAY_HANDLER:CHILD_OBJECT_HANDLER;proxyMap.set(r,{replicant:e,path:t}),o=new Proxy(r,a)}for(var p in r)if(r.hasOwnProperty(p)){var n=p.replace(/\//g,"~1");if(t){var i=joinPathParts(t,n);r[p]=proxyRecursive(e,r[p],i)}else r[p]=proxyRecursive(e,r[p],n)}return o}return r}function joinPathParts(e,r){return e.endsWith("/")?""+e+r:e+"/"+r}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},objectPath=require("object-path"),proxyMap=new WeakMap,ARRAY_MUTATOR_METHODS=["copyWithin","fill","pop","push","reverse","shift","sort","splice","unshift"],deleteTrap=function(e,r){var t=proxyMap.get(e);return t.replicant._ignoreProxy?delete e[r]:(t.replicant._addOperation(t.path,"delete",{prop:r}),process.browser?void 0:delete e[r])},CHILD_ARRAY_HANDLER={get:function(e,r){var t=proxyMap.get(e),o=t.replicant;return t.replicant._ignoreProxy?e[r]:ARRAY_MUTATOR_METHODS.indexOf(r)>=0?process.browser?function(){t.replicant._addOperation(t.path,r,Array.prototype.slice.call(arguments))}:function(){o._ignoreProxy=!0,t.replicant._addOperation(t.path,r,Array.prototype.slice.call(arguments));var a=e[r].apply(e,arguments);return o._ignoreProxy=!1,proxyRecursive(o,e,t.path),a}:e[r]},set:function(e,r,t){if(e[r]===t)return!0;var o=proxyMap.get(e),a=o.replicant;return a._ignoreProxy?(e[r]=t,!0):(e.hasOwnProperty(r)?a._addOperation(o.path,"update",{prop:r,newValue:t}):a._addOperation(o.path,"add",{prop:r,newValue:t}),process.browser||(e[r]=proxyRecursive(o.replicant,t,joinPathParts(o.path,r))),!0)},deleteProperty:deleteTrap},CHILD_OBJECT_HANDLER={get:function(e,r){return e[r]},set:function(e,r,t){if(e[r]===t)return!0;var o=proxyMap.get(e),a=o.replicant;return a._ignoreProxy?(e[r]=t,!0):(e.hasOwnProperty(r)?a._addOperation(o.path,"update",{prop:r,newValue:t}):a._addOperation(o.path,"add",{prop:r,newValue:t}),process.browser||(e[r]=proxyRecursive(o.replicant,t,joinPathParts(o.path,r))),!0)},deleteProperty:deleteTrap};module.exports={ARRAY_MUTATOR_METHODS:ARRAY_MUTATOR_METHODS,_proxyRecursive:proxyRecursive,applyOperation:function(e,r){e._ignoreProxy=!0;var t=r.path.substr(1).split("/").map(function(e){return e.replace(/~1/g,"/")});if(1===t.length&&""===t[0]&&(t=[]),ARRAY_MUTATOR_METHODS.indexOf(r.method)>=0){var o=objectPath.get(e.value,t);o[r.method].apply(o,r.args),this._proxyRecursive(e,o,r.path)}else switch(r.method){case"add":case"update":t.push(r.args.prop);var a=r.args.newValue;"object"===("undefined"==typeof a?"undefined":_typeof(a))&&(a=this._proxyRecursive(e,a,r.path)),objectPath.set(e.value,t,a);break;case"delete":if(0===t.length||objectPath.has(e.value,t)){var p=objectPath.get(e.value,t);delete p[r.args.prop]}break;default:throw new Error('Unexpected operation method "'+r.method+'"')}e._ignoreProxy=!1}};
}).call(this,require('_process'))
