...
"use strict";function NodeCG(e,n){var t=this,o=this;this.bundleName=e.name,this.bundleConfig=e.config,this.log=require("./browser/logger")(e.name),this._messageHandlers=[],document.addEventListener("DOMContentLoaded",function(){""===document.title&&(document.title=o.bundleName)},!1),this.socket=n,this.socket.emit("joinRoom",e.name),window._ncgHasSounds&&(createjs.Sound.on("fileerror",function(e){console.log("fileerror",e)}),createjs.Sound.on("fileload",function(e){console.log("fileload",e)}),this._soundCues=new Replicant("soundCues",this.bundleName,{},n),this._soundFiles=new Replicant("uploads:sounds",this.bundleName,{},n),this._bundleVolume=new Replicant("volume:"+this.bundleName,"_sounds",{},n),this._masterVolume=new Replicant("volume:master","_sounds",{},n),this._soundCues.on("change",function(){_updateInstanceVolumes.bind(t)(),_registerSounds.bind(t)()}),this._soundFiles.on("change",_registerSounds.bind(this)),this._bundleVolume.on("change",_updateInstanceVolumes.bind(this)),this._masterVolume.on("change",_updateInstanceVolumes.bind(this))),n.on("message",function(e){o.log.trace("Received message %s (sent to bundle %s) with data:",e.messageName,e.bundleName,e.content),o._messageHandlers.forEach(function(n){e.messageName===n.messageName&&e.bundleName===n.bundleName&&n.func(e.content)})}),n.on("error",function(e){if("UnauthorizedError"===e.type){var n=[location.protocol,"//",location.host,location.pathname].join("");window.location.href="/authError?code="+e.code+"&message="+e.message+"&viewUrl="+n}else o.log.error("Unhandled socket error:",e)}),Object.defineProperty(this,"config",{value:filteredConfig,writable:!1,enumerable:!0}),Object.freeze(this.config)}function _registerSounds(){this._soundCues.value.forEach(function(e){e.file&&(_registeredSums.has(e.file.sum)||(createjs.Sound.registerSound(e.file.url+"?sum="+e.file.sum,e.name,{channels:100}),_registeredSums.add(e.file.sum)))}),this.soundsReady||(this.soundsReady=!0,document.dispatchEvent(new CustomEvent("ncgSoundsReady")))}function _setInstanceVolume(e,n){e.volume=n.volume*this._bundleVolume.value*this._masterVolume.value}function _updateInstanceVolumes(){var e=this;this._soundCues.value.forEach(function(n){createjs.Sound._instances.forEach(function(t){t.cueName===n.name&&t.updateVolume&&_setInstanceVolume.bind(e)(t,n)})})}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},Replicant=require("./browser/replicant"),server=require("./server"),filteredConfig=require("./browser/config").filteredConfig,utils=require("./util"),replicator=require("./replicator"),io=void 0;NodeCG.prototype.sendMessage=function(e,n,t){"undefined"==typeof t&&"function"==typeof n&&(t=n,n=null),this.sendMessageToBundle(e,this.bundleName,n,t)},NodeCG.sendMessageToBundle=function(e,n,t,o){"undefined"==typeof o&&"function"==typeof t&&(o=t,t=null),window.socket.emit("message",{bundleName:n,messageName:e,content:t},o)},NodeCG.prototype.sendMessageToBundle=function(e,n,t,o){this.log.trace("[%s] Sending message %s to bundle %s with data:",this.bundleName,e,n,t),NodeCG.sendMessageToBundle.apply(NodeCG,arguments)},NodeCG.prototype.listenFor=function(e,n,t){if("undefined"==typeof t&&(t=n,n=this.bundleName),"function"!=typeof t)throw new Error('argument "handler" must be a function, but you provided a(n) '+("undefined"==typeof t?"undefined":_typeof(t)));this.log.trace("[%s] Listening for %s from bundle %s",this.bundleName,e,n);for(var o=this._messageHandlers.length,s=0;o>s;s++){var i=this._messageHandlers[s];if(e===i.messageName&&n===i.bundleName)return void this.log.error('%s attempted to declare a duplicate "listenFor" handler:',this.bundleName,n,e)}this._messageHandlers.push({messageName:e,bundleName:n,func:t})},NodeCG.declaredReplicants=Replicant.declaredReplicants,NodeCG.Replicant=function(e,n,t){return new Replicant(e,n,t,window.socket)},NodeCG.prototype.Replicant=function(e,n,t){return n&&"string"==typeof n||(t=n,n=this.bundleName),new NodeCG.Replicant(e,n,t)},NodeCG.readReplicant=function(e,n,t){if(!e||"string"!=typeof e)throw new Error("Must supply a name when reading a Replicant");if(!n||"string"!=typeof n)throw new Error("Must supply a bundle name when reading a Replicant");window.socket.emit("readReplicant",{name:e,bundle:n},t)},NodeCG.prototype.readReplicant=function(e,n,t){return n&&"string"==typeof n||(t=n,n=this.bundleName),NodeCG.readReplicant(e,n,t)},window.NodeCG=NodeCG,NodeCG.prototype.getDialog=function(e,n){return n=n||this.bundleName,window.top.document.getElementById(n+"_"+e)},NodeCG.prototype.getDialogDocument=function(e,n){return n=n||this.bundleName,this.getDialog(e,n).querySelector("iframe").contentWindow.document},window._ncgHasSounds&&(NodeCG.prototype.playSound=function(e){var n=this,t=arguments.length<=1||void 0===arguments[1]?{updateVolume:!0}:arguments[1],o=t.updateVolume,s=createjs.Sound.play(e);return s.cueName=e,this._soundCues.value.some(function(t){return t.name===e?(_setInstanceVolume.bind(n)(s,t),!0):!1}),s.updateVolume=o,s},NodeCG.prototype.stopSound=function(e){createjs.Sound._instances.forEach(function(n){n.cueName===e&&n.stop()})},NodeCG.prototype.stopAllSounds=function(){createjs.Sound.stop()});var _registeredSums=new Set;module.exports=NodeCG;
