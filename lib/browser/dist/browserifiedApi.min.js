...
},{"base64-js":7,"ieee754":17,"isarray":22}],10:[function(require,module,exports){
(function (Buffer){
...
!function(e,t){"use strict";"object"==typeof module&&"object"==typeof module.exports?module.exports=t():"function"==typeof define&&define.amd?define([],t):e.objectPath=t()}(this,function(){"use strict";function e(e){if(!e)return!0;if(l(e)&&0===e.length)return!0;if("string"!=typeof e){for(var t in e)if(f.call(e,t))return!1;return!0}return!1}function t(e){return o.call(e)}function r(e){return"object"==typeof e&&"[object Object]"===t(e)}function n(e){return"boolean"==typeof e||"[object Boolean]"===t(e)}function i(e){var t=parseInt(e);return t.toString()===e?t:e}function u(t){function u(e,r){if(t.includeInheritedProps||"number"==typeof r&&Array.isArray(e)||f.call(e,r))return e[r]}function o(e,t,r,n){if("number"==typeof t&&(t=[t]),!t||0===t.length)return e;if("string"==typeof t)return o(e,t.split(".").map(i),r,n);var f=t[0],l=u(e,f);return 1===t.length?(void 0!==l&&n||(e[f]=r),l):(void 0===l&&("number"==typeof t[1]?e[f]=[]:e[f]={}),o(e[f],t.slice(1),r,n))}t=t||{};var c=function(e){return Object.keys(c).reduce(function(t,r){return"create"===r?t:("function"==typeof c[r]&&(t[r]=c[r].bind(c,e)),t)},{})};return c.has=function(e,r){if(null==e)return!1;if("number"==typeof r?r=[r]:"string"==typeof r&&(r=r.split(".")),!r||0===r.length)return!1;for(var n=0;n<r.length;n++){var u=i(r[n]);if(!("number"==typeof u&&l(e)&&u<e.length||(t.includeInheritedProps?u in Object(e):f.call(e,u))))return!1;e=e[u]}return!0},c.ensureExists=function(e,t,r){return o(e,t,r,!0)},c.set=function(e,t,r,n){return o(e,t,r,n)},c.insert=function(e,t,r,n){var i=c.get(e,t);n=~~n,l(i)||(i=[],c.set(e,t,i)),i.splice(n,0,r)},c.empty=function(t,i){if(!e(i)&&null!=t){var u,o;if(u=c.get(t,i)){if("string"==typeof u)return c.set(t,i,"");if(n(u))return c.set(t,i,!1);if("number"==typeof u)return c.set(t,i,0);if(l(u))u.length=0;else{if(!r(u))return c.set(t,i,null);for(o in u)f.call(u,o)&&delete u[o]}}}},c.push=function(e,t){var r=c.get(e,t);l(r)||(r=[],c.set(e,t,r)),r.push.apply(r,Array.prototype.slice.call(arguments,2))},c.coalesce=function(e,t,r){for(var n,i=0,u=t.length;i<u;i++)if(void 0!==(n=c.get(e,t[i])))return n;return r},c.get=function(e,t,r){if("number"==typeof t&&(t=[t]),!t||0===t.length)return e;if(null==e)return r;if("string"==typeof t)return c.get(e,t.split("."),r);var n=i(t[0]),o=u(e,n);return void 0===o?r:1===t.length?o:c.get(e[n],t.slice(1),r)},c.del=function(t,r){if("number"==typeof r&&(r=[r]),null==t)return t;if(e(r))return t;if("string"==typeof r)return c.del(t,r.split("."));var n=i(r[0]),o=u(t,n);if(null==o)return o;if(1===r.length)l(t)?t.splice(n,1):delete t[n];else if(void 0!==t[n])return c.del(t[n],r.slice(1));return t},c}var o=Object.prototype.toString,f=Object.prototype.hasOwnProperty,l=Array.isArray||function(e){return"[object Array]"===o.call(e)},c=u();return c.create=u,c.withInheritedProps=u({includeInheritedProps:!0}),c});
...
},{"./support/isBuffer":26,"_process":25,"inherits":18}],28:[function(require,module,exports){
