...
(function (process){
"use strict";function NodeCG(e,n){var t=this,o=this;this.bundleName=e.name,this.bundleConfig=e.config,this.log=require("./browser/logger")(e.name),this._messageHandlers=[],process.browser?(document.addEventListener("DOMContentLoaded",function(){""===document.title&&(document.title=o.bundleName)},!1),this.socket=n,this.socket.emit("joinRoom",e.name),e._hasSounds&&window.createjs&&createjs.Sound&&(this._soundCues=new Replicant("soundCues",this.bundleName,{},n),this._soundFiles=new Replicant("assets:sounds",this.bundleName,{},n),this._bundleVolume=new Replicant("volume:"+this.bundleName,"_sounds",{},n),this._masterVolume=new Replicant("volume:master","_sounds",{},n),this._soundCues.on("change",function(){_updateInstanceVolumes(t),_registerSounds(t)}),this._soundFiles.on("change",function(){return _registerSounds(t)}),this._bundleVolume.on("change",function(){return _updateInstanceVolumes(t)}),this._masterVolume.on("change",function(){return _updateInstanceVolumes(t)})),n.on("message",function(e){o.log.trace("Received message %s (sent to bundle %s) with data:",e.messageName,e.bundleName,e.content),o._messageHandlers.forEach(function(n){e.messageName===n.messageName&&e.bundleName===n.bundleName&&n.func(e.content)})}),n.on("error",function(e){if("UnauthorizedError"===e.type){var n=[location.protocol,"//",location.host,location.pathname].join("");window.location.href="/authError?code="+e.code+"&message="+e.message+"&viewUrl="+n}else o.log.error("Unhandled socket error:",e)})):(io=server.getIO(),io.on("connection",function(e){e.setMaxListeners(64),e.on("message",function(e,n){o.log.trace("[%s] Received message %s (sent to bundle %s) with data:",o.bundleName,e.messageName,e.bundleName,e.content),o._messageHandlers.forEach(function(t){e.messageName===t.messageName&&e.bundleName===t.bundleName&&t.func(e.content,n)})})})),Object.defineProperty(this,"config",{value:filteredConfig,writable:!1,enumerable:!0}),Object.freeze(this.config)}function _registerSounds(e){e._soundCues.value.forEach(function(e){e.file&&createjs.Sound.registerSound(e.file.url+"?sum="+e.file.sum,e.name,{channels:100})}),e.soundsReady||(e.soundsReady=!0,window.dispatchEvent(new CustomEvent("ncgSoundsReady")))}function _setInstanceVolume(e,n,t){n.volume=e._masterVolume.value/100*(e._bundleVolume.value/100)*(t.volume/100)}function _updateInstanceVolumes(e){e._soundCues.value.forEach(function(n){createjs.Sound._instances.forEach(function(t){t.cueName===n.name&&t.updateVolume&&_setInstanceVolume(e,t,n)})})}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},Replicant=require("./browser/replicant"),server=require("./server"),filteredConfig=require("./browser/config").filteredConfig,utils=require("./util"),replicator=require("./replicator"),io=void 0;NodeCG.prototype.sendMessage=function(e,n,t){"undefined"==typeof t&&"function"==typeof n&&(t=n,n=null),this.sendMessageToBundle(e,this.bundleName,n,t)},NodeCG.sendMessageToBundle=function(e,n,t,o){process.browser?("undefined"==typeof o&&"function"==typeof t&&(o=t,t=null),window.socket.emit("message",{bundleName:n,messageName:e,content:t},o)):io.emit("message",{bundleName:n,messageName:e,content:t})},NodeCG.prototype.sendMessageToBundle=function(e,n,t,o){this.log.trace("[%s] Sending message %s to bundle %s with data:",this.bundleName,e,n,t),NodeCG.sendMessageToBundle.apply(NodeCG,arguments)},NodeCG.prototype.listenFor=function(e,n,t){if("undefined"==typeof t&&(t=n,n=this.bundleName),"function"!=typeof t)throw new Error('argument "handler" must be a function, but you provided a(n) '+("undefined"==typeof t?"undefined":_typeof(t)));this.log.trace("[%s] Listening for %s from bundle %s",this.bundleName,e,n);for(var o=this._messageHandlers.length,s=0;o>s;s++){var r=this._messageHandlers[s];if(e===r.messageName&&n===r.bundleName)return void this.log.error('%s attempted to declare a duplicate "listenFor" handler:',this.bundleName,n,e)}this._messageHandlers.push({messageName:e,bundleName:n,func:t})},NodeCG.declaredReplicants=Replicant.declaredReplicants,NodeCG.Replicant=function(e,n,t){return new Replicant(e,n,t,process.browser?window.socket:null)},NodeCG.prototype.Replicant=function(e,n,t){return n&&"string"==typeof n||(t=n,n=this.bundleName),new NodeCG.Replicant(e,n,t)},NodeCG.readReplicant=function(e,n,t){if(!e||"string"!=typeof e)throw new Error("Must supply a name when reading a Replicant");if(!n||"string"!=typeof n)throw new Error("Must supply a bundle name when reading a Replicant");if(process.browser)window.socket.emit("replicant:read",{name:e,bundle:n},t);else{var o=replicator.find(e,n);if(o)return o.value}},NodeCG.prototype.readReplicant=function(e,n,t){return n&&"string"==typeof n||(t=n,n=this.bundleName),NodeCG.readReplicant(e,n,t)},process.browser?(window.NodeCG=NodeCG,NodeCG.prototype.getDialog=function(e,n){return n=n||this.bundleName,window.top.document.getElementById(n+"_"+e)},NodeCG.prototype.getDialogDocument=function(e,n){return n=n||this.bundleName,this.getDialog(e,n).querySelector("iframe").contentWindow.document},NodeCG.prototype.playSound=function(e,n){var t=this;if(!this._soundCues)throw new Error('Bundle "'+this.bundleName+'" has no soundCues');var o=this._soundCues.value.find(function(n){return n.name===e});if(!o)throw new Error('Cue "'+e+'" does not exist in bundle "'+this.bundleName+'"');if(!window.createjs||!window.createjs.Sound)throw new Error("NodeCG Sound API methods are not available when SoundJS isn't present");if(o.file){n=n||{},void 0===n.updateVolume&&(n.updateVolume=!0);var s=createjs.Sound.play(e);return s.cueName=e,this._soundCues.value.some(function(n){return n.name===e?(_setInstanceVolume(t,s,n),!0):!1}),s.updateVolume=n.updateVolume,s}},NodeCG.prototype.stopSound=function(e){if(!this._soundCues)throw new Error('Bundle "'+this.bundleName+'" has no soundCues');if(!this._soundCues.value.find(function(n){return n.name===e}))throw new Error('Cue "'+e+'" does not exist in bundle "'+this.bundleName+'"');if(!window.createjs||!window.createjs.Sound)throw new Error("NodeCG Sound API methods are not available when SoundJS isn't present");for(var n=createjs.Sound._instances.length-1;n>=0;n--){var t=createjs.Sound._instances[n];t.cueName===e&&t.stop()}},NodeCG.prototype.stopAllSounds=function(){if(!window.createjs||!window.createjs.Sound)throw new Error("NodeCG Sound API methods are not available when SoundJS isn't present");createjs.Sound.stop()}):(NodeCG.prototype.getSocketIOServer=server.getIO,NodeCG.prototype.mount=server.mount,NodeCG.prototype.util={},NodeCG.prototype.util.authCheck=utils.authCheck,Object.defineProperty(NodeCG.prototype,"extensions",{get:function(){return server.getExtensions()},enumerable:!0})),module.exports=NodeCG;
