...
(function (process){
"use strict";function NodeCG(e,n){var o=this,t=this;this.bundleName=e.name,this.bundleConfig=e.config,this.log=require("./browser/logger")(e.name),this._messageHandlers=[],process.browser?(document.addEventListener("DOMContentLoaded",function(){""===document.title&&(document.title=t.bundleName)},!1),this.socket=n,this.socket.emit("joinRoom",e.name),e._hasSounds&&window.createjs&&createjs.Sound&&!function(){o._soundCues=new Replicant("soundCues",o.bundleName,{},n),o._soundFiles=new Replicant("assets:sounds",o.bundleName,{},n),o._bundleVolume=new Replicant("volume:"+o.bundleName,"_sounds",{},n),o._masterVolume=new Replicant("volume:master","_sounds",{},n);var e=new Set;createjs.Sound.on("fileload",function(n){if(!o.soundsReady&&n.data.sum){e.add(n.data.sum);var t=o._soundCues.value.some(function(n){return!!n.file&&!e.has(n.file.sum)});t||o.soundsReady||(o.soundsReady=!0,window.dispatchEvent(new CustomEvent("ncgSoundsReady")))}}),o._soundCues.on("change",function(){_updateInstanceVolumes(o),_registerSounds(o)}),o._soundFiles.on("change",function(){return _registerSounds(o)}),o._bundleVolume.on("change",function(){return _updateInstanceVolumes(o)}),o._masterVolume.on("change",function(){return _updateInstanceVolumes(o)})}(),n.on("message",function(e){t.log.trace("Received message %s (sent to bundle %s) with data:",e.messageName,e.bundleName,e.content),t._messageHandlers.forEach(function(n){e.messageName===n.messageName&&e.bundleName===n.bundleName&&n.func(e.content)})}),n.on("error",function(e){if("UnauthorizedError"===e.type){var n=[location.protocol,"//",location.host,location.pathname].join("");window.location.href="/authError?code="+e.code+"&message="+e.message+"&viewUrl="+n}else t.log.error("Unhandled socket error:",e)})):(io=server.getIO(),io.on("connection",function(e){e.setMaxListeners(64),e.on("message",function(e,n){t.log.trace("[%s] Received message %s (sent to bundle %s) with data:",t.bundleName,e.messageName,e.bundleName,e.content),t._messageHandlers.forEach(function(o){e.messageName===o.messageName&&e.bundleName===o.bundleName&&o.func(e.content,n)})})})),Object.defineProperty(this,"config",{value:filteredConfig,writable:!1,enumerable:!0}),Object.freeze(this.config)}function _registerSounds(e){e._soundCues.value.forEach(function(e){e.file&&createjs.Sound.registerSound(e.file.url+"?sum="+e.file.sum,e.name,{channels:"undefined"==typeof e.channels?100:e.channels,sum:e.file.sum})})}function _setInstanceVolume(e,n,o){n.volume=e._masterVolume.value/100*(e._bundleVolume.value/100)*(o.volume/100)}function _updateInstanceVolumes(e){e._soundCues.value.forEach(function(n){createjs.Sound._instances.forEach(function(o){o.cueName===n.name&&o.updateVolume&&_setInstanceVolume(e,o,n)})})}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},Replicant=require("./browser/replicant"),server=require("./server"),filteredConfig=require("./browser/config").filteredConfig,utils=require("./util"),replicator=require("./replicator"),io=void 0;NodeCG.prototype.sendMessage=function(e,n,o){"undefined"==typeof o&&"function"==typeof n&&(o=n,n=null),this.sendMessageToBundle(e,this.bundleName,n,o)},NodeCG.sendMessageToBundle=function(e,n,o,t){process.browser?("undefined"==typeof t&&"function"==typeof o&&(t=o,o=null),window.socket.emit("message",{bundleName:n,messageName:e,content:o},t)):io.emit("message",{bundleName:n,messageName:e,content:o})},NodeCG.prototype.sendMessageToBundle=function(e,n,o,t){this.log.trace("[%s] Sending message %s to bundle %s with data:",this.bundleName,e,n,o),NodeCG.sendMessageToBundle.apply(NodeCG,arguments)},NodeCG.prototype.listenFor=function(e,n,o){if("undefined"==typeof o&&(o=n,n=this.bundleName),"function"!=typeof o)throw new Error('argument "handler" must be a function, but you provided a(n) '+("undefined"==typeof o?"undefined":_typeof(o)));this.log.trace("[%s] Listening for %s from bundle %s",this.bundleName,e,n);for(var t=this._messageHandlers.length,s=0;s<t;s++){var u=this._messageHandlers[s];if(e===u.messageName&&n===u.bundleName)return void this.log.error('%s attempted to declare a duplicate "listenFor" handler:',this.bundleName,n,e)}this._messageHandlers.push({messageName:e,bundleName:n,func:o})},NodeCG.declaredReplicants=Replicant.declaredReplicants,NodeCG.Replicant=function(e,n,o){return new Replicant(e,n,o,process.browser?window.socket:null)},NodeCG.prototype.Replicant=function(e,n,o){return n&&"string"==typeof n||(o=n,n=this.bundleName),new NodeCG.Replicant(e,n,o)},NodeCG.readReplicant=function(e,n,o){if(!e||"string"!=typeof e)throw new Error("Must supply a name when reading a Replicant");if(!n||"string"!=typeof n)throw new Error("Must supply a bundle name when reading a Replicant");if(process.browser)window.socket.emit("replicant:read",{name:e,bundle:n},o);else{var t=replicator.find(e,n);if(t)return t.value}},NodeCG.prototype.readReplicant=function(e,n,o){return n&&"string"==typeof n||(o=n,n=this.bundleName),NodeCG.readReplicant(e,n,o)},process.browser?(window.NodeCG=NodeCG,NodeCG.prototype.getDialog=function(e,n){return n=n||this.bundleName,window.top.document.getElementById(n+"_"+e)},NodeCG.prototype.getDialogDocument=function(e,n){return n=n||this.bundleName,this.getDialog(e,n).querySelector("iframe").contentWindow.document},NodeCG.prototype.playSound=function(e,n){var o=this;if(!this._soundCues)throw new Error('Bundle "'+this.bundleName+'" has no soundCues');var t=this._soundCues.value.find(function(n){return n.name===e});if(!t)throw new Error('Cue "'+e+'" does not exist in bundle "'+this.bundleName+'"');if(!window.createjs||!window.createjs.Sound)throw new Error("NodeCG Sound API methods are not available when SoundJS isn't present");if(t.file){n=n||{},void 0===n.updateVolume&&(n.updateVolume=!0);var s=createjs.Sound.play(e);return s.cueName=e,this._soundCues.value.some(function(n){return n.name===e&&(_setInstanceVolume(o,s,n),!0)}),s.updateVolume=n.updateVolume,s}},NodeCG.prototype.stopSound=function(e){if(!this._soundCues)throw new Error('Bundle "'+this.bundleName+'" has no soundCues');if(!this._soundCues.value.find(function(n){return n.name===e}))throw new Error('Cue "'+e+'" does not exist in bundle "'+this.bundleName+'"');if(!window.createjs||!window.createjs.Sound)throw new Error("NodeCG Sound API methods are not available when SoundJS isn't present");for(var n=createjs.Sound._instances.length-1;n>=0;n--){var o=createjs.Sound._instances[n];o.cueName===e&&o.stop()}},NodeCG.prototype.stopAllSounds=function(){if(!window.createjs||!window.createjs.Sound)throw new Error("NodeCG Sound API methods are not available when SoundJS isn't present");createjs.Sound.stop()}):(NodeCG.prototype.getSocketIOServer=server.getIO,NodeCG.prototype.mount=server.mount,NodeCG.prototype.util={},NodeCG.prototype.util.authCheck=utils.authCheck,Object.defineProperty(NodeCG.prototype,"extensions",{get:function(){return server.getExtensions()},enumerable:!0})),module.exports=NodeCG;
...
"use strict";var Logger=require("@nodecg/logger")(window.ncgConfig.logging);module.exports=function(g){return new Logger(g)};
},{"@nodecg/logger":6}],4:[function(require,module,exports){
(function (process){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),EventEmitter=require("events"),equal=require("deep-equal"),clone=require("clone"),shared=require("../replicant/shared"),declaredReplicants={},REPLICANT_HANDLER={get:function(e,t){return e[t]},set:function(e,t,n){return"value"!==t||e._ignoreProxy?(e[t]=n,!0):n===e[t]?(e.log.replicants("value unchanged, no action will be taken"),!0):(e.validate(n),e.log.replicants("running setter with",n),"declared"!==e.status?(e._queueAction(e._proposeAssignment,[n]),!0):(e._proposeAssignment(n),!0))}},Replicant=function(e){function t(e,n,i,s){var a;if(_classCallCheck(this,t),!e||"string"!=typeof e)throw new Error("Must supply a name when instantiating a Replicant");if(!n||"string"!=typeof n)throw new Error("Must supply a bundle name when instantiating a Replicant");var r=_possibleConstructorReturn(this,(t.__proto__||Object.getPrototypeOf(t)).call(this));if(r.log=require("./logger")("Replicant/"+n+"."+e),{}.hasOwnProperty.call(declaredReplicants,n)){if({}.hasOwnProperty.call(declaredReplicants[n],e)){var o;return r.log.replicants("Existing replicant found, returning that instead of creating a new one."),o=declaredReplicants[n][e],_possibleConstructorReturn(r,o)}}else declaredReplicants[n]={};i=i||{},r.value=void 0,r.name=e,r.bundle=n,r.opts=i,r.revision=0,r.status="undeclared",r._socket=s,"undefined"==typeof i.persistent&&(i.persistent=!0),r.on("newListener",function(e,t){"change"===e&&"declared"===r.status&&t(r.value)}),r._actionQueue=[],r._operationQueue=[],r.validate=function(){return!0},r._declare(),s.on("replicant:assignment",function(e){return r._handleAssignment(e)}),s.on("replicant:operations",function(e){return r._handleOperations(e)}),s.on("disconnect",function(){return r._handleDisconnect()}),s.on("reconnect",function(){return r._declare()});var u=new Proxy(r,REPLICANT_HANDLER);return declaredReplicants[n][e]=u,a=u,_possibleConstructorReturn(r,a)}return _inherits(t,e),_createClass(t,[{key:"_addOperation",value:function(e,t,n){var i=this;this._operationQueue.push({path:e,method:t,args:n}),this._pendingOperationFlush||(this._pendingOperationFlush=!0,"declared"===this.status?process.nextTick(function(){return i._flushOperations()}):this._queueAction(this._flushOperations))}},{key:"_flushOperations",value:function(){var e=this;this._pendingOperationFlush=!1,this._socket.emit("replicant:proposeOperations",{name:this.name,bundle:this.bundle,operations:this._operationQueue,revision:this.revision,persistent:this.opts.persistent,schemaSum:this.schemaSum},function(t){if(t.schema&&(e.schema=t.schema,e.schemaSum=t.schemaSum),t.revision&&t.revision!==e.revision&&(e.log.warn("Not at head revision (ours %s, theirs %s). Change aborted & head revision applied.",e.revision,t.revision),e._assignValue(t.value,t.revision)),t.rejectReason){if(!(e.listenerCount("operationsRejected")>0))throw new Error(t.rejectReason);e.emit("operationsRejected",t.rejectReason)}}),this._operationQueue=[]}},{key:"_queueAction",value:function(e,t){this._actionQueue.push({fn:e,args:t})}},{key:"_proposeAssignment",value:function(e){var t=this;this._socket.emit("replicant:proposeAssignment",{name:this.name,bundle:this.bundle,value:e,persistent:this.opts.persistent,schemaSum:this.schemaSum},function(e){if(e.schema&&(t.schema=e.schema,t.schemaSum=e.schemaSum),e.rejectReason){if(!(t.listenerCount("assignmentRejected")>0))throw new Error(e.rejectReason);t.emit("assignmentRejected",e.rejectReason)}})}},{key:"_declare",value:function(){var e=this;"declared"!==this.status&&"declaring"!==this.status&&(this.status="declaring",this._socket.emit("joinRoom",this.bundle,function(){e._socket.emit("replicant:declare",{name:e.name,bundle:e.bundle,defaultValue:e.opts.defaultValue,persistent:e.opts.persistent},function(t){if(t.rejectReason){if(!(e.listenerCount("declarationRejected")>0))throw new Error(t.rejectReason);e.emit("declarationRejected",t.rejectReason)}e.log.replicants("declareReplicant callback (value: %s, revision: %s)",t.value,t.revision),e.revision===t.revision&&equal(e.value,t.value)||e._assignValue(t.value,t.revision),t.schema&&(e.schema=t.schema,e.schemaSum=t.schemaSum,e.validate=shared.generateValidator(e)),e.status="declared",e.emit("declared",t),void 0===e.value&&0===e.revision&&e.emit("change"),e._actionQueue.length>0&&(e._actionQueue.forEach(function(t){t.fn.apply(e,t.args)}),e._actionQueue=[])})}))}},{key:"_assignValue",value:function(e,t){var n=clone(this.value);this.value=shared._proxyRecursive(this,e,"/"),"undefined"!=typeof t&&(this.revision=t),this.emit("change",this.value,n)}},{key:"_handleAssignment",value:function(e){e.name===this.name&&e.bundle===this.bundle&&(this.log.replicants("received replicantAssigned",e),this._assignValue(e.newValue,e.revision))}},{key:"_handleOperations",value:function(e){var t=this;if("declared"===this.status){var n=this.revision+1;if(e.name===this.name&&e.bundle===this.bundle){if(e.revision!==n)return this.log.warn('Not at head revision (ours: "%s", expected theirs to be "%s" but got "%s"), fetching latest...',this.revision,n,e.revision),void this._fullUpdate();this.log.replicants("received replicantOperations",e);var i=clone(this.value);e.operations.forEach(function(e){e.result=shared.applyOperation(t,e)}),this.revision=e.revision,this.emit("change",this.value,i,e.operations)}}}},{key:"_handleDisconnect",value:function(){this.status="undeclared",this._operationQueue.length=0,this._actionQueue.length=0}},{key:"_fullUpdate",value:function(){var e=this;NodeCG.readReplicant(this.name,this.bundle,function(t){e.emit("fullUpdate",t),e._assignValue(t.value,t.revision)})}}]),t}(EventEmitter);module.exports=Replicant;
}).call(this,require('_process'))

},{"../replicant/shared":5,"./logger":3,"_process":24,"clone":10,"deep-equal":11,"events":14}],5:[function(require,module,exports){
(function (process){
"use strict";function proxyRecursive(e,t,r){if("object"===("undefined"==typeof t?"undefined":_typeof(t))&&null!==t){var a=void 0;if(proxySet.has(t)){a=t;var o=proxyMetadataMap.get(t);o.path=r}else if(metadataMap.has(t)){var p=metadataMap.get(t);a=p.proxy,p.path=r}else{var n=Array.isArray(t)?CHILD_ARRAY_HANDLER:CHILD_OBJECT_HANDLER;a=new Proxy(t,n),proxySet.add(a);var i={replicant:e,path:r,proxy:a};metadataMap.set(t,i),proxyMetadataMap.set(a,i)}for(var l in t)if({}.hasOwnProperty.call(t,l)){var d=l.replace(/\//g,"~1");if(r){var c=joinPathParts(r,d);t[l]=proxyRecursive(e,t[l],c)}else t[l]=proxyRecursive(e,t[l],d)}return a}return t}function joinPathParts(e,t){return e.endsWith("/")?""+e+t:e+"/"+t}function pathStrToPathArr(e){return e=e.substr(1).split("/").map(function(e){return e.replace(/~1/g,"/")}),1===e.length&&""===e[0]&&(e=[]),e}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e},validator=require("is-my-json-valid"),clone=require("clone"),objectPath=require("object-path"),proxyMetadataMap=new WeakMap,metadataMap=new WeakMap,proxySet=new WeakSet,ARRAY_MUTATOR_METHODS=["copyWithin","fill","pop","push","reverse","shift","sort","splice","unshift"],deleteTrap=function(e,t){var r=metadataMap.get(e),a=r.replicant;if(a._ignoreProxy)return delete e[t];if(!{}.hasOwnProperty.call(e,t))return!0;if(a.schema){var o=clone(a.value),p=objectPath.get(o,pathStrToPathArr(r.path));delete p[t],a.validate(o)}return a._addOperation(r.path,"delete",{prop:t}),process.browser?void 0:delete e[t]},CHILD_ARRAY_HANDLER={get:function(e,t){var r=metadataMap.get(e),a=r.replicant;return r.replicant._ignoreProxy?e[t]:{}.hasOwnProperty.call(Array.prototype,t)&&"function"==typeof Array.prototype[t]&&e[t]===Array.prototype[t]&&ARRAY_MUTATOR_METHODS.indexOf(t)>=0?function(){if(a.schema){var o=clone(a.value),p=objectPath.get(o,pathStrToPathArr(r.path));p[t].apply(p,arguments),a.validate(o)}if(!process.browser){a._ignoreProxy=!0,r.replicant._addOperation(r.path,t,Array.prototype.slice.call(arguments));var n=e[t].apply(e,arguments);return a._ignoreProxy=!1,proxyRecursive(a,e,r.path),n}r.replicant._addOperation(r.path,t,Array.prototype.slice.call(arguments))}:e[t]},set:function(e,t,r){if(e[t]===r)return!0;var a=metadataMap.get(e),o=a.replicant;if(o._ignoreProxy)return e[t]=r,!0;if(o.schema){var p=clone(o.value),n=objectPath.get(p,pathStrToPathArr(a.path));n[t]=r,o.validate(p)}return{}.hasOwnProperty.call(e,t)?o._addOperation(a.path,"update",{prop:t,newValue:r}):o._addOperation(a.path,"add",{prop:t,newValue:r}),process.browser||(e[t]=proxyRecursive(a.replicant,r,joinPathParts(a.path,t))),!0},deleteProperty:deleteTrap},CHILD_OBJECT_HANDLER={get:function(e,t){return e[t]},set:function(e,t,r){if(e[t]===r)return!0;var a=metadataMap.get(e),o=a.replicant;if(o._ignoreProxy)return e[t]=r,!0;if(o.schema){var p=clone(o.value),n=objectPath.get(p,pathStrToPathArr(a.path));n[t]=r,o.validate(p)}return{}.hasOwnProperty.call(e,t)?o._addOperation(a.path,"update",{prop:t,newValue:r}):o._addOperation(a.path,"add",{prop:t,newValue:r}),process.browser||(e[t]=proxyRecursive(a.replicant,r,joinPathParts(a.path,t))),!0},deleteProperty:deleteTrap};module.exports={ARRAY_MUTATOR_METHODS:ARRAY_MUTATOR_METHODS,_proxyRecursive:proxyRecursive,applyOperation:function(e,t){e._ignoreProxy=!0;var r=void 0,a=pathStrToPathArr(t.path);if(ARRAY_MUTATOR_METHODS.indexOf(t.method)>=0){var o=objectPath.get(e.value,a);r=o[t.method].apply(o,t.args),this._proxyRecursive(e,o,t.path)}else switch(t.method){case"add":case"update":a.push(t.args.prop);var p=t.args.newValue;"object"===("undefined"==typeof p?"undefined":_typeof(p))&&(p=this._proxyRecursive(e,p,t.path)),r=objectPath.set(e.value,a,p);break;case"delete":if(0===a.length||objectPath.has(e.value,a)){var n=objectPath.get(e.value,a);r=delete n[t.args.prop]}break;default:throw new Error('Unexpected operation method "'+t.method+'"')}return e._ignoreProxy=!1,r},generateValidator:function(e){var t=validator(e.schema,{greedy:!0,verbose:!0});return function(){var r=arguments.length<=0||void 0===arguments[0]?e.value:arguments[0],a=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],o=a.throwOnInvalid,p=void 0===o||o,n=t(r);if(p&&!n){var i='Invalid value for replicant "'+e.name+'" in bundle "'+e.bundle+'" rejected:\n',l=t.errors;throw l.forEach(function(e){var t=e.field.replace("data.","");i+="is the wrong type"===e.message?'\tField "'+t+'" '+e.message+'. Value "'+e.value+'" (type: '+_typeof(e.value)+') was provided, expected type "'+e.type+'"\n ':'\tField "'+t+'" '+e.message+"\n"}),new Error(i)}return n}}};
}).call(this,require('_process'))

},{"_process":24,"clone":10,"is-my-json-valid":19,"object-path":23}],6:[function(require,module,exports){
"use strict";var LOG_LEVELS={trace:0,debug:1,info:2,warn:3,error:4,_infinite:1/0},ENUM_LEVELS={trace:"The highest level of logging, logs everything.",debug:"Less spammy than trace, includes most info relevant for debugging.",info:"The default logging level. Logs useful info, warnings, and errors.",warn:"Only logs warnings and errors.",error:"Only logs errors."};module.exports=function(e){function n(e){this.name=e}function o(e){e=e||{},e.console=e.console||{},"undefined"!=typeof e.console.enabled&&(n._silent=!e.console.enabled),"undefined"!=typeof e.console.level&&(n._level=e.console.level),"undefined"!=typeof e.replicants&&(n._shouldLogReplicants=e.replicants)}return e=e||{},e.console=e.console||{},n.prototype={trace:function(){n._silent||LOG_LEVELS[n._level]>LOG_LEVELS.trace||(arguments[0]="["+this.name+"] "+arguments[0],console.info.apply(console,arguments))},debug:function(){n._silent||LOG_LEVELS[n._level]>LOG_LEVELS.debug||(arguments[0]="["+this.name+"] "+arguments[0],console.info.apply(console,arguments))},info:function(){n._silent||LOG_LEVELS[n._level]>LOG_LEVELS.info||(arguments[0]="["+this.name+"] "+arguments[0],console.info.apply(console,arguments))},warn:function(){n._silent||LOG_LEVELS[n._level]>LOG_LEVELS.warn||(arguments[0]="["+this.name+"] "+arguments[0],console.warn.apply(console,arguments))},error:function(){n._silent||LOG_LEVELS[n._level]>LOG_LEVELS.error||(arguments[0]="["+this.name+"] "+arguments[0],console.error.apply(console,arguments))},replicants:function(){n._silent||n._shouldLogReplicants&&(arguments[0]="["+this.name+"] "+arguments[0],console.info.apply(console,arguments))}},n.globalReconfigure=function(e){o(e)},n._level="info",n._silent=!0,n._shouldLogReplicants=!1,o(e),n};
...
},{"base64-js":7,"ieee754":17,"isarray":21}],10:[function(require,module,exports){
(function (Buffer){
var clone=function(){"use strict";function e(t,n,r,o){function a(t,r){if(null===t)return null;if(0===r)return t;var l,v;if("object"!=typeof t)return t;if(t instanceof i)l=new i;else if(t instanceof u)l=new u;else if(t instanceof c)l=new c(function(e,n){t.then(function(t){e(a(t,r-1))},function(e){n(a(e,r-1))})});else if(e.__isArray(t))l=[];else if(e.__isRegExp(t))l=new RegExp(t.source,f(t)),t.lastIndex&&(l.lastIndex=t.lastIndex);else if(e.__isDate(t))l=new Date(t.getTime());else{if(y&&Buffer.isBuffer(t))return l=new Buffer(t.length),t.copy(l),l;"undefined"==typeof o?(v=Object.getPrototypeOf(t),l=Object.create(v)):(l=Object.create(o),v=o)}if(n){var b=s.indexOf(t);if(b!=-1)return p[b];s.push(t),p.push(l)}if(t instanceof i)for(var d=t.keys();;){var g=d.next();if(g.done)break;var j=a(g.value,r-1),_=a(t.get(g.value),r-1);l.set(j,_)}if(t instanceof u)for(var x=t.keys();;){var g=x.next();if(g.done)break;var O=a(g.value,r-1);l.add(O)}for(var w in t){var h;v&&(h=Object.getOwnPropertyDescriptor(v,w)),h&&null==h.set||(l[w]=a(t[w],r-1))}if(Object.getOwnPropertySymbols)for(var m=Object.getOwnPropertySymbols(t),w=0;w<m.length;w++){var P=m[w];l[P]=a(t[P],r-1)}return l}var l;"object"==typeof n&&(r=n.depth,o=n.prototype,l=n.filter,n=n.circular);var s=[],p=[],y="undefined"!=typeof Buffer;return"undefined"==typeof n&&(n=!0),"undefined"==typeof r&&(r=1/0),a(t,r)}function t(e){return Object.prototype.toString.call(e)}function n(e){return"object"==typeof e&&"[object Date]"===t(e)}function r(e){return"object"==typeof e&&"[object Array]"===t(e)}function o(e){return"object"==typeof e&&"[object RegExp]"===t(e)}function f(e){var t="";return e.global&&(t+="g"),e.ignoreCase&&(t+="i"),e.multiline&&(t+="m"),t}var i;try{i=Map}catch(e){i=function(){}}var u;try{u=Set}catch(e){u=function(){}}var c;try{c=Promise}catch(e){c=function(){}}return e.clonePrototype=function(e){if(null===e)return null;var t=function(){};return t.prototype=e,new t},e.__objToStr=t,e.__isDate=n,e.__isArray=r,e.__isRegExp=o,e.__getRegExpFlags=f,e}();"object"==typeof module&&module.exports&&(module.exports=clone);
...
},{"is-property":20}],17:[function(require,module,exports){
...
},{"./formats":18,"generate-function":15,"generate-object-property":16,"jsonpointer":22,"xtend":28}],20:[function(require,module,exports){
...
!function(e,t){"use strict";"object"==typeof module&&"object"==typeof module.exports?module.exports=t():"function"==typeof define&&define.amd?define([],t):e.objectPath=t()}(this,function(){"use strict";function e(e,t){return null!=e&&Object.prototype.hasOwnProperty.call(e,t)}function t(t){if(!t)return!0;if(l(t)&&0===t.length)return!0;if("string"!=typeof t){for(var r in t)if(e(t,r))return!1;return!0}return!1}function r(e){return f.call(e)}function n(e){return"object"==typeof e&&"[object Object]"===r(e)}function i(e){return"boolean"==typeof e||"[object Boolean]"===r(e)}function u(e){var t=parseInt(e);return t.toString()===e?t:e}function o(r){function o(t,n){if(r.includeInheritedProps||"number"==typeof n&&Array.isArray(t)||e(t,n))return t[n]}function f(e,t,r,n){if("number"==typeof t&&(t=[t]),!t||0===t.length)return e;if("string"==typeof t)return f(e,t.split(".").map(u),r,n);var i=t[0],l=o(e,i);return 1===t.length?(void 0!==l&&n||(e[i]=r),l):(void 0===l&&("number"==typeof t[1]?e[i]=[]:e[i]={}),f(e[i],t.slice(1),r,n))}r=r||{};var c=function(e){return Object.keys(c).reduce(function(t,r){return"create"===r?t:("function"==typeof c[r]&&(t[r]=c[r].bind(c,e)),t)},{})};return c.has=function(t,n){if("number"==typeof n?n=[n]:"string"==typeof n&&(n=n.split(".")),!n||0===n.length)return!!t;for(var i=0;i<n.length;i++){var o=u(n[i]);if(!("number"==typeof o&&l(t)&&o<t.length||(r.includeInheritedProps?o in Object(t):e(t,o))))return!1;t=t[o]}return!0},c.ensureExists=function(e,t,r){return f(e,t,r,!0)},c.set=function(e,t,r,n){return f(e,t,r,n)},c.insert=function(e,t,r,n){var i=c.get(e,t);n=~~n,l(i)||(i=[],c.set(e,t,i)),i.splice(n,0,r)},c.empty=function(r,u){if(!t(u)&&null!=r){var o,f;if(o=c.get(r,u)){if("string"==typeof o)return c.set(r,u,"");if(i(o))return c.set(r,u,!1);if("number"==typeof o)return c.set(r,u,0);if(l(o))o.length=0;else{if(!n(o))return c.set(r,u,null);for(f in o)e(o,f)&&delete o[f]}}}},c.push=function(e,t){var r=c.get(e,t);l(r)||(r=[],c.set(e,t,r)),r.push.apply(r,Array.prototype.slice.call(arguments,2))},c.coalesce=function(e,t,r){for(var n,i=0,u=t.length;i<u;i++)if(void 0!==(n=c.get(e,t[i])))return n;return r},c.get=function(e,t,r){if("number"==typeof t&&(t=[t]),!t||0===t.length)return e;if(null==e)return r;if("string"==typeof t)return c.get(e,t.split("."),r);var n=u(t[0]),i=o(e,n);return void 0===i?r:1===t.length?i:c.get(e[n],t.slice(1),r)},c.del=function(e,r){if("number"==typeof r&&(r=[r]),null==e)return e;if(t(r))return e;if("string"==typeof r)return c.del(e,r.split("."));var n=u(r[0]),i=o(e,n);if(null==i)return i;if(1===r.length)l(e)?e.splice(n,1):delete e[n];else if(void 0!==e[n])return c.del(e[n],r.slice(1));return e},c}var f=Object.prototype.toString,l=Array.isArray||function(e){return"[object Array]"===f.call(e)},c=o();return c.create=o,c.withInheritedProps=o({includeInheritedProps:!0}),c});
