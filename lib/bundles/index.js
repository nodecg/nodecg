    ...
    self.all()
        .then(function (bundles) {
            bundles.forEach(function(bundle) {
                var bndlPath = 'bundles/' + bundle.name + '/';
                if (!fs.existsSync(bndlPath + "nodecg.json")) {
                    console.log('[lib/bundle/index.js] ' + bundle.name + '\'s nodecg.json can no longer be found on disk, assuming the bundle has been deleted or moved');
