...
server.on('started', function() {
    ...
    io.sockets.on('connection', function (socket) {
        socket.on('declareReplicant', function (data, cb) {
            console.log('declareReplicant', data);
...
exports.declare = function(name, bundle, defaultValue) {
    ...
    this.emitToAll('replicantDeclared', {
        name: name,
        bundle: bundle,
        value: defaultValue,
        revision: 0
...
exports.assign = function(name, bundle, value) {
    ...
    this.emitToAll('replicantAssigned', {
        name: name,
        bundle: bundle,
        value: value
    });
...
exports.change = function(name, bundle, changes) {
    ...
    this.emitToAll('replicantChanged', {
        name: name,
        bundle: bundle,
